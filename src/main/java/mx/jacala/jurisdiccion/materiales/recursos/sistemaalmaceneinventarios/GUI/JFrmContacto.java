 ...
 * @author INVENTARIOS
 */
public class JFrmContacto extends javax.swing.JFrame {

    /**
     * Creates new form JFrmContacto
     */
    public JFrmContacto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Motivo de contacto:");

        jButton1.setText("Enviar correo");

        jButton2.setText("Enviar whatsapp (web)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmContacto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmContacto().setVisible(true);
            }
        });
    }
